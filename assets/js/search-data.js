...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Google Scholar — https://scholar.google.com/citations?hl=zh-CN&amp;user=2OKn9p4AAAAJ",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-dr-shi-gave-a-talk-at-the-institute-of-biomedical-engineering-at-oxford",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-8539-6873", "_blank");
        },
      },{
        id: 'social-scholar',
